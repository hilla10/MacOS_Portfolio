...
const mobileWallpaper = [
  {
    id: 11,
    mode: 'dark',
    img: '/mobile/wallpaper/wallpaper-apple-dark.jpg',
    isPhoneScreen: true,
  },
  {
    id: 12,
    mode: 'dark',
    img: '/mobile/wallpaper/wallpaper-blue-glass-dark.jpg',
    isPhoneScreen: true,
  },
  {
    id: 13,
    mode: 'dark',
    img: '/mobile/wallpaper/wallpaper-color-dark.jpg',
    isPhoneScreen: true,
  },
  {
    id: 14,
    mode: 'dark',
    img: '/mobile/wallpaper/wallpaper-iphone-dark.jpg',
    isPhoneScreen: true,
  },
  {
    id: 15,
    mode: 'dark',
    img: '/mobile/wallpaper/wallpaper-monterey-dark.jpg',
    isPhoneScreen: true,
  },
  {
    id: 16,
    mode: 'dark',
    img: '/mobile/wallpaper/wallpaper-ventura-dark.jpeg',
    isPhoneScreen: true,
  },
  {
    id: 17,
    mode: 'light',
    img: '/mobile/wallpaper/wallpaper-blue-light.webp',
    isPhoneScreen: true,
  },
  {
    id: 18,
    mode: 'light',
    img: '/mobile/wallpaper/wallpaper-color-light.jpg',
    isPhoneScreen: true,
  },
  {
    id: 19,
    mode: 'light',
    img: '/mobile/wallpaper/wallpaper-duvar-light.jpg',
    isPhoneScreen: true,
  },
  {
    id: 20,
    mode: 'light',
    img: '/mobile/wallpaper/wallpaper-light.png',
    isPhoneScreen: true,
  },
  {
    id: 21,
    mode: 'light',
    img: '/mobile/wallpaper/wallpaper-liquid-light.jpg',
    isPhoneScreen: true,
  },
  {
    id: 22,
    mode: 'light',
    img: '/mobile/wallpaper/wallpaper-tahoe-light.jpg',
    isPhoneScreen: true,
  },
  {
    id: 23,
    mode: 'light',
    img: '/mobile/wallpaper/wallpaper-ventura-light.avif',
    isPhoneScreen: true,
  },
];
